...
public class StudentSortingTest {
	...
	public void setUp() {
		...
		populaVetorElementosNegativos(new Integer[] { -40, 100, 20, 34, -7, -2, -3 });
	...
	public void populaVetorElementosNegativos(Integer[] arrayPadrao) {
	...
	// TESTE EXCLUSIVO PARA A CLASSE ==> ExtendedCountingSort
	@Test
	public void testAdicionalExtendedCountingSort() {
